  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Animated gradient beams (pure CSS hardware accelerated) */}
        {pathData.map((d, i) => (
          <path
            key={`beam-${i}`}
            d={d}
            ...
            strokeWidth="1.2"
            strokeLinecap="round"
            className="beam-animated-path"
            style={{
              animationDuration: `${animations[i].duration}s`,
              animationDelay: `${animations[i].delay}s`,
            }}
          />
        ))}
